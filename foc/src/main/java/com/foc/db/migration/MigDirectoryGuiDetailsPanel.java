...
public class MigDirectoryGuiDetailsPanel extends FPanel{

	public final static int VIEW_SELECTION = 2; 
	
	public MigDirectoryGuiDetailsPanel(FocObject obj, int viewID){
		if(viewID == VIEW_SELECTION){
			...
			FGTextField comp = (FGTextField) add(obj, MigDirectoryDesc.FLD_DIR_PATH, 0, 1);
			comp.setColumns(40);
