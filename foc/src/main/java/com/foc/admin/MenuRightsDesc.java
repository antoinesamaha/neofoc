...
public class MenuRightsDesc extends FocDesc{
  ...
  public static final int FLD_FATHER_MENU_RIGHT = FField.FLD_FATHER_NODE_FIELD_ID;
  ...
  public static final String DB_TABLE_NAME = "MENU_RIGHTS";
  
  public MenuRightsDesc() {
    super(MenuRights.class, FocDesc.DB_RESIDENT, DB_TABLE_NAME, false);
    
    FField fField = addReferenceField();
    
    setWithObjectTree();
    FObjectField fatherFld = (FObjectField) getFieldByID(FLD_FATHER_MENU_RIGHT);
    ...
    FObjectField objectField = new FObjectField("GROUP", "Group", FLD_GROUP, false, FocGroupDesc.getInstance(), FLD_NAME_GROUP_PREFIX, this, FocGroupDesc.FLD_MENU_RIGHTS_LIST);
  ...
  public static FocDesc getInstance() {
  	return getInstance(DB_TABLE_NAME, MenuRightsDesc.class);
  }
