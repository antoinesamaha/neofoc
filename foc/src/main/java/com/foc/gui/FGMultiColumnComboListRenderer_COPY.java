...
public class FGMultiColumnComboListRenderer_COPY extends JLabel implements ListCellRenderer {
  ...
  public FGMultiColumnComboListRenderer_COPY(FocList focList, int keyFieldId, FTableView tableView) {
    super();
