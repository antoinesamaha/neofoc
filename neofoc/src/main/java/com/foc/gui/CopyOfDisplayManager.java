 ...
 * @author 01Barmaja
 */
public class CopyOfDisplayManager {
  ...
  public CopyOfDisplayManager(int guiNavigatorType) {
    ...
    backgroundColor = new Color(70, 70, 83);//bleu fonce
    //backgroundColor = new Color(114, 124, 163);//bleu fonce
