...
public class FTypeDateTime extends FocFieldTypAbstract<FocDateTime> {

	@Override
	public String getTypeName() {
		return TYPE_DATETIME_FIELD;
	}

	@Override
	public FField newFField(Class focObjClass, Field f, FocDateTime a) {		
		FField focField = null;
		focField = new FDateTimeField(getDBFieldName(f), getFieldTitle(f), FField.NO_FIELD_ID, false);
