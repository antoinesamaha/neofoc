...
class NeoFocApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp.router(
      ...
      routerConfig: appRouter, // Use the imported appRouter
    );
  }
  ...
  //         theme: ThemeData(),
  //         darkTheme: ThemeData.light(), //dark
  ...
  //     return MaterialPageRoute<void>(
  //       settings: routeSettings,
  //       builder: (BuildContext context) => LoginPage(logo: const Icon(Icons.local_hospital, size: 80, color: Colors.blueAccent), appName: "Labotron"),
  //     );
